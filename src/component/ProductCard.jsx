...
const ProductCard = () => {
  const { data = [], addToCart } = useContext(contexts); // Default `data` to an empty array
  ...
  // Ensure data is an array before slicing and mapping
  const products = Array.isArray(data) ? data.slice(0, 9) : [];
